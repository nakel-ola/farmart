...
const createAddress = (0, authenticated_1.default)((args, req) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const input = args.input, userId = req.userId, name = (0, xss_1.default)(input.name), street = (0, xss_1.default)(input.street), city = (0, xss_1.default)(input.city), state = (0, xss_1.default)(input.state), country = (0, xss_1.default)(input.country), info = (0, xss_1.default)(input === null || input === void 0 ? void 0 : input.info), phoneNumber = (0, xss_1.default)(input.phoneNumber), phoneNumber2 = (0, xss_1.default)(input === null || input === void 0 ? void 0 : input.phoneNumber2);
