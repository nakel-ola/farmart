...
const changePassword = (args) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const token = jsonwebtoken_1.default.sign({ id: newUser._id, name, email, photoUrl: newUser.photoUrl }, config_1.default.jwt_key, { expiresIn: config_1.default.expiresIn });
...
const modifyUser = (0, authenticated_1.default)((args, req) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let userId = (0, xss_1.default)(req.userId), input = args.input, email = (0, xss_1.default)(input.email), name = (0, xss_1.default)(input.name), gender = (0, xss_1.default)(input.gender), birthday = (0, xss_1.default)(input.birthday), phoneNumber = (0, xss_1.default)(input.phoneNumber);
...
const blockUser = (0, authenticated_1.default)((args, req) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let admin = req.admin, customerId = args.input.customerId, email = args.input.email, blocked = args.input.blocked;
        if (!admin) {
