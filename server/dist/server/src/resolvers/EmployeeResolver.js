...
const employeeRegister = (0, authenticated_1.default)((args) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const employeeLogin = (args) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let token = jsonwebtoken_1.default.sign(Object.assign({ id: user._id }, user), config_1.default.jwt_key, {
            expiresIn: config_1.default.expiresIn,
        });
        return { token };
    }
...
const employeeChangePassword = (args) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const inviteEmployee = (0, authenticated_1.default)((args, req) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let admin = req.admin, email = (0, xss_1.default)(args.input.email), level = (0, xss_1.default)(args.input.level);
        if (!admin) {
            throw new Error("You don't have permission to create an employee");
        }
        yield models_1.default.inviteSchema.create({ email, level });
