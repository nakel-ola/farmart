...
const products = (args) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
        let genre = (0, xss_1.default)(args.input.genre);
        ...
        const data = yield (genre
            ? models_1.default.productSchema.find({ category: genre })
            : models_1.default.productSchema.find());
        let newData = {
            genre,
...
const productSearch = (args) => __awaiter(void 0, void 0, void 0, function* () {
    var _c, _d;
    try {
        let search = (0, xss_1.default)(args.input.search), offset = Number((0, xss_1.default)((_c = args.input.offset) !== null && _c !== void 0 ? _c : 0)), limit = Number((0, xss_1.default)((_d = args.input.limit) !== null && _d !== void 0 ? _d : 10)) + offset;
        const data = yield models_1.default.productSchema.find({
            $or: [
...
const categories = (args) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const createCategories = (0, authenticated_1.default)((args, req) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let admin = req.admin, categories = args.categories.map((category) => ({ name: (0, xss_1.default)(category) }));
        if (!admin) {
...
const reviews = (0, authenticated_1.default)((args, req) => __awaiter(void 0, void 0, void 0, function* () {
    var _e;
    try {
        ...
        return (_e = data.reviews) !== null && _e !== void 0 ? _e : [];
    }
    catch (err) {
        console.log(err);
        throw new Error(err.message);
...
const createProduct = (0, authenticated_1.default)((args, req) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let admin = req.admin, input = args.input, title = (0, xss_1.default)(input.title), slug = (0, xss_1.default)(input.slug), category = (0, xss_1.default)(input.category), description = (0, xss_1.default)(input.description), image = yield input.image, price = Number((0, xss_1.default)(input.price)), stock = Number((0, xss_1.default)(input.stock)), rating = 0, currency = {
        ...
        if (newData) {
            return Object.assign({ id: newData._id }, data);
        }
    }
    catch (err) {
        console.log(err);
...
const modifyProduct = (0, authenticated_1.default)((args, req) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        let admin = req.admin, input = args.input, id = (0, xss_1.default)(input.id), title = (0, xss_1.default)(input.title), slug = (0, xss_1.default)(input.slug), category = (0, xss_1.default)(input.category), description = (0, xss_1.default)(input.description), image = (input === null || input === void 0 ? void 0 : input.image)
            ? {
                name: (0, xss_1.default)((_f = input === null || input === void 0 ? void 0 : input.image) === null || _f === void 0 ? void 0 : _f.name),
                url: (0, xss_1.default)((_g = input === null || input === void 0 ? void 0 : input.image) === null || _g === void 0 ? void 0 : _g.url),
            }
            : null, imageUpload = yield input.imageUpload, price = Number((0, xss_1.default)(input.price)), stock = Number((0, xss_1.default)(input.stock)), currency = {
            name: (0, xss_1.default)(input.currency.name),
            symbol: (0, xss_1.default)(input.currency.symbol),
            symbolNative: (0, xss_1.default)(input.currency.symbolNative),
            decimalDigits: (0, xss_1.default)(input.currency.decimalDigits),
...
const productsSummary = (0, authenticated_1.default)((args, req) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const data = {
            ...
            retailvalue: products.reduce((amount, item) => amount + item.price * item.stock, 0),
        };
        return data;
    }
    catch (err) {
