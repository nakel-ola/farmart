...
const products = (args, req) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c;
    try {
        let genre = args.input.genre ? (0, xss_1.default)(args.input.genre) : null, offset = Number((0, xss_1.default)((_a = args.input.offset.toString()) !== null && _a !== void 0 ? _a : "0")), limit = Number((0, xss_1.default)((_b = args.input.limit.toString()) !== null && _b !== void 0 ? _b : "10")) + offset, outOfStock = (_c = args.input) === null || _c === void 0 ? void 0 : _c.outOfStock, admin = req.admin;
        if (outOfStock && !admin) {
...
const createReview = (0, authenticated_1.default)((args, req) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield models_1.default.productSchema.updateOne({ _id: productId, "rating.name": rating }, { $inc: { "rating.$.value": 1 } });
