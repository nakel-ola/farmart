...
const productsSummary = (_, args, ctx) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { db } = ctx;
        ...
        if (redisCache)
            return redisCache;
        const products = yield db.products.find();
...
exports.default = productsSummary;
//# sourceMappingURL=products-summary.js.map