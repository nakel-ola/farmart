...
const createCategories = (_, args, ctx) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { db } = ctx;
        const categories = args.categories.map((category) => ({
            name: category,
        }));
        yield db.categories.insertMany(categories);
...
//# sourceMappingURL=create-categories.js.map