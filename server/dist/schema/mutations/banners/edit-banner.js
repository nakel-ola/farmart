...
const editBanner = (_, args, ctx) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const _a = args.input, { id } = _a, others = __rest(_a, ["id"]);
        yield ctx.db.banners.updateOne({ _id: id }, (0, clean_1.default)(others));
...
//# sourceMappingURL=edit-banner.js.map