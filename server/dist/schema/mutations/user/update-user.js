...
const updateUser = (_, args, ctx) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (args.input.level && !req.admin)
            throw new Error("Access denied");
        const userId = uid !== null && uid !== void 0 ? uid : user === null || user === void 0 ? void 0 : user._id.toString();
        const data = (0, clean_1.default)(Object.assign(Object.assign({}, others), { level: req.admin ? args.input.level : null }));
