...
const authenticated = (fn) => (args, req, res, context, info) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (req.headers.cookie) {
            ...
            let admin = (_a = parse[config_1.default.admin_session_name]) !== null && _a !== void 0 ? _a : "";
            let client = (_b = parse[config_1.default.client_session_name]) !== null && _b !== void 0 ? _b : "";
            if (req.admin && admin) {
                const data = yield getDb(admin, req.admin);
                req.userId = data.id;
                req.level = data.level;
                return fn(args, req, res, context, info);
            }
            else if (!req.admin && client) {
                const data = yield getDb(client, req.admin);
                req.userId = data.id;
...
const getDb = (value, admin) => new Promise((resolve, reject) => {
    ...
    index_1.MemoryStore.get(data, (err, session) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        var decodedToken = jsonwebtoken_1.default.verify((0, xss_1.default)(admin ? session === null || session === void 0 ? void 0 : session.auth_admin : (_a = session === null || session === void 0 ? void 0 : session.auth) !== null && _a !== void 0 ? _a : ""), config_1.default.jwt_key);
